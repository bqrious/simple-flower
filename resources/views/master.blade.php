...
<head>
    <meta charset="utf-8">
    <title>@yield('title', 'Flower')</title>
    <meta name="description" content="Flower Shopping Cart">
...
<body>
        ...
        <nav class="navbar navbar-default navbar-static-top">
          <div class="container">
            <div class="navbar-header">
              ...
              <a class="navbar-brand" href="{{ url('/') }}">Flower Shopping Cart</a>
            </div>
    ...
    <footer>
      <div class="container">
        <p class="text-muted">By <a href="http://necessity.tech">Hidayat</a></p>
      </div>
    </footer>
