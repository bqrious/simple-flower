    ...
    <div class="container">
            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><a href="{{ url('shop', [$item->model->slug]) }}">{{ $item->code }}</a></td>
                        <td>
                    ...
                    <tr class="border-bottom">
                        ...
                        <td>           
                            <button type="button" class="btn btn-success btn-sm" data-toggle="modal" data-target="#practice_modal">Apply Discount Coupon</button>
                        </td>
                        <td></td>
                    </tr>
                    ...
                    <tr>
                        <td class="table-image"></td>
                        <td></td>
                        <td class="small-caps table-bg" style="text-align: right">Total After Discount</td>
                        <td>{{$total_disx}}</td>
                        <td></td>
                        <td></td>
                    </tr>
        ...
        <div class="modal fade" id="practice_modal">
                        <div class="modal-dialog">                     
                           <form action="{{ url('discount') }}" method="POST" class="side-by-side">
                                {!! csrf_field() !!}
                                <input type="text" name="coupon" id="coupon" value="" class="form-control">
                                <input type="submit" class="btn btn-danger btn-sm" value="Apply Discount Coupon">
                            </form>
                        </div>
                    </div>
